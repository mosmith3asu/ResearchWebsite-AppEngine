...
# CFG = Config(r".\config.yaml")
# fname_config = os.getcwd() + '/apps/static/PursuitGame/config.yaml'

fname_config = os.getcwd() + '/static/PursuitGame/config.yaml'

CFG = Config(fname_config)
